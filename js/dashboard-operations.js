...
function renderTributeFeedCard(tribute) {
    ...
    return `
        <div class="feed-trib-card">
            <img src="${tribute.memberAvatar || tribute.avatar || tribute.profilePicture || ''}" class="ft-avatar" onerror="this.style.display='none'">
...
function renderCompletionFeedCard(completion) {
    ...
    return `
        <div class="feed-buy-card">
            <img src="${completion.avatar || completion.profilePicture || ''}" class="ft-avatar" onerror="this.style.display='none'">
            <div class="ft-content">
                <div class="ft-top">
