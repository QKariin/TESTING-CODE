    ...
    try {
        ...
        if (!isRoutine) {
            ...
            if (isTooLong) {
                ...
                (window as any)._restoreTaskAfterFail = () => {
                    if (readyText) { readyText.innerHTML = ""; readyText.style.color = "white"; }
                    if (mobTaskText) { mobTaskText.innerHTML = ""; mobTaskText.style.color = "white"; }
                    if (uploadCont) uploadCont.style.display = "flex";
                    if (mobUploadCont) mobUploadCont.style.display = "flex";
                    restoreTimer();
                };
