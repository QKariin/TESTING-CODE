                    ...
                    <div id="gridTask" className="v-card serve-grid-item" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 10, minHeight: 'unset' }}>
                        ...
                        <div className="task-interface-container" style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            ...
                            <div id="activeTaskContent" className="hidden" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 10 }}>
                                ...
                                <div id="skipConfirmContainer" style={{ display: 'none', flexDirection: 'column', gap: 15, marginTop: 15, alignItems: 'center', background: 'rgba(20, 0, 0, 0.6)', border: '1px solid rgba(255, 0, 60, 0.4)', boxShadow: '0 0 20px rgba(255, 0, 60, 0.1)', backdropFilter: 'blur(10px)', padding: '25px', borderRadius: '12px', width: '100%' }}>
                                    <div style={{ color: '#ff003c', fontFamily: 'Cinzel', fontSize: '1.2rem', textAlign: 'center', fontWeight: 'bold', letterSpacing: '2px', textShadow: '0 0 10px rgba(255,0,0,0.5)' }}>PENALTY WARNING</div>
                                    <div style={{ color: '#ccc', fontFamily: 'Orbitron', fontSize: '0.8rem', textAlign: 'center', marginBottom: 5, lineHeight: 1.5 }}>Are you sure you want to skip?<br />This will deduct <span style={{ color: '#ff003c', fontWeight: 'bold' }}>300 Capital</span>.</div>
                                    <button id="btnConfirmSkip" onClick={() => (window as any).executeSkipTask()} className="action-btn" style={{ width: '80%', background: 'linear-gradient(90deg, #ff003c 0%, #8b0000 100%)', color: 'white', fontWeight: 'bold', border: '1px solid #ff003c', boxShadow: '0 0 15px rgba(255,0,60,0.4)', borderRadius: '8px', padding: '12px', fontSize: '0.85rem', letterSpacing: '2px', cursor: 'pointer', transition: 'all 0.3s ease' }}>ACCEPT PENALTY (-300)</button>
                                    <button id="btnCancelSkip" onClick={() => (window as any).cancelSkipTask()} className="text-btn" style={{ color: '#888', fontFamily: 'Orbitron', fontSize: '0.75rem', letterSpacing: '1px', padding: 5, width: '80%', background: 'none', border: 'none', cursor: 'pointer', transition: 'color 0.2s' }}>NEVERMIND, I WILL SERVE</button>
                                </div>
                            ...
                            <div className="luxury-card" style={{ padding: '15px 5px' }}>
                                ...
                                <div id="qm_TaskActive" className="hidden" style={{ textAlign: 'center' }}>
                                    ...
                                    <div id="mobSkipConfirmContainer" style={{ display: 'none', flexDirection: 'column', gap: 15, marginTop: 15, alignItems: 'center', background: 'rgba(20, 0, 0, 0.6)', border: '1px solid rgba(255, 0, 60, 0.4)', boxShadow: '0 0 20px rgba(255, 0, 60, 0.1)', backdropFilter: 'blur(10px)', padding: '25px', borderRadius: '12px', width: '100%' }}>
                                        <div style={{ color: '#ff003c', fontFamily: 'Cinzel', fontSize: '1.2rem', textAlign: 'center', fontWeight: 'bold', letterSpacing: '2px', textShadow: '0 0 10px rgba(255,0,0,0.5)' }}>PENALTY WARNING</div>
                                        <div style={{ color: '#ccc', fontFamily: 'Orbitron', fontSize: '0.8rem', textAlign: 'center', marginBottom: 5, lineHeight: 1.5 }}>Are you sure you want to skip?<br />This will deduct <span style={{ color: '#ff003c', fontWeight: 'bold' }}>300 Capital</span>.</div>
                                        <button id="btnMobConfirmSkip" onClick={() => (window as any).executeSkipTask()} className="action-btn" style={{ width: '80%', background: 'linear-gradient(90deg, #ff003c 0%, #8b0000 100%)', color: 'white', fontWeight: 'bold', border: '1px solid #ff003c', boxShadow: '0 0 15px rgba(255,0,60,0.4)', borderRadius: '8px', padding: '12px', fontSize: '0.85rem', letterSpacing: '2px', cursor: 'pointer', transition: 'all 0.3s ease' }}>ACCEPT PENALTY (-300)</button>
                                        <button id="btnMobCancelSkip" onClick={() => (window as any).cancelSkipTask()} className="text-btn" style={{ color: '#888', fontFamily: 'Orbitron', fontSize: '0.75rem', letterSpacing: '1px', padding: 5, width: '80%', background: 'none', border: 'none', cursor: 'pointer', transition: 'color 0.2s' }}>NEVERMIND, I WILL SERVE</button>
                                    </div>
