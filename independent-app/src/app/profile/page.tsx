                    ...
                    <div id="gridTask" className="v-card serve-grid-item" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 10, minHeight: 'unset' }}>
                        ...
                        <div className="task-interface-container" style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            ...
                            <div id="activeTaskContent" className="hidden" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 10 }}>
                                ...
                                <div id="skipConfirmContainer" style={{ display: 'none', flexDirection: 'column', gap: 10, marginTop: 10, alignItems: 'center', background: 'rgba(255,0,0,0.1)', border: '1px solid var(--red)', padding: '15px', borderRadius: '8px' }}>
                                    <div style={{ color: 'var(--red)', fontFamily: 'Cinzel', fontSize: '0.9rem', textAlign: 'center', fontWeight: 'bold' }}>⚠️ PENALTY WARNING ⚠️</div>
                                ...
                                <div id="dismissTaskContainer" style={{ display: 'none', flexDirection: 'column', gap: 5, marginTop: 15, alignItems: 'center', width: '100%' }}>
                                    <button id="btnDismissTask" onClick={() => (window as any).resetTaskUI()} className="action-btn" style={{ width: '100%', background: 'rgba(255,255,255,0.1)', color: 'white', fontWeight: 'bold', border: '2px solid white', padding: '15px', fontSize: '0.75rem', letterSpacing: '1px', whiteSpace: 'nowrap' }}>THANK YOU, QUEEN KARIN</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div style={{ width: '100%', marginTop: '20px' }}>
                            ...
                            <div className="luxury-card" style={{ padding: '15px 5px' }}>
                                ...
                                <div id="qm_TaskActive" className="hidden" style={{ textAlign: 'center' }}>
                                    ...
                                    <div id="mobSkipConfirmContainer" style={{ display: 'none', flexDirection: 'column', gap: '8px', marginTop: '10px', background: 'rgba(255,0,0,0.1)', border: '1px solid var(--red)', padding: '12px', borderRadius: '8px' }}>
                                        <div style={{ color: 'var(--red)', fontFamily: 'Cinzel', fontSize: '0.8rem', textAlign: 'center', fontWeight: 'bold' }}>⚠️ PENALTY WARNING</div>
                                    ...
                                    <div id="mobDismissContainer" style={{ display: 'none', flexDirection: 'column', gap: '5px', marginTop: '15px' }}>
                                        <button id="mobBtnDismissTask" className="btn-upload-sm" style={{ borderColor: 'rgba(255,255,255,0.4)', borderWidth: '2px', color: 'white', padding: '15px 0', fontSize: '0.75rem', whiteSpace: 'nowrap', width: '100%' }} onClick={() => (window as any).resetTaskUI()}>THANK YOU, QUEEN KARIN</button>
                                    </div>
                                </div>
                            </div>
                        </div>
