                    ...
                    <div id="gridTask" className="v-card serve-grid-item" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 10, minHeight: 'unset' }}>
                        ...
                        <div className="task-interface-container" style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            ...
                            <div id="activeTaskContent" className="hidden" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 10 }}>
                                ...
                                <div id="skipConfirmContainer" style={{ display: 'none', flexDirection: 'column', gap: 10, marginTop: 10, alignItems: 'center', background: 'rgba(255,0,0,0.1)', border: '1px solid var(--red)', padding: '15px', borderRadius: '8px', width: '100%' }}>
                                    <div style={{ color: 'var(--red)', fontFamily: 'Cinzel', fontSize: '1rem', textAlign: 'center', fontWeight: 'bold' }}>PENALTY WARNING</div>
                                    <div style={{ color: '#fff', fontFamily: 'Orbitron', fontSize: '0.75rem', textAlign: 'center', marginBottom: 5 }}>Are you sure you want to skip?<br />This will cost you 300 Capital.</div>
                                    <button id="btnConfirmSkip" onClick={() => (window as any).executeSkipTask()} className="action-btn" style={{ width: '70%', background: 'var(--red)', color: 'white', fontWeight: 'bold', boxShadow: '0 0 10px rgba(255,0,0,0.4)', borderColor: 'var(--red)', display: 'block' }}>ACCEPT PENALTY (-300)</button>
                                    <button id="btnCancelSkip" onClick={() => (window as any).cancelSkipTask()} className="text-btn" style={{ color: '#aaa', fontSize: '0.7rem', padding: 5, width: '70%', background: 'none', border: 'none', display: 'block' }}>NEVERMIND, I WILL SERVE</button>
                                </div>
                        ...
                        <div style={{ width: '100%', marginTop: '20px' }}>
                            ...
                            <div className="luxury-card" style={{ padding: '15px 5px' }}>
                                ...
                                <div id="qm_TaskActive" className="hidden" style={{ textAlign: 'center' }}>
                                    ...
                                    <div id="mobSkipConfirmContainer" style={{ display: 'none', flexDirection: 'column', gap: '8px', marginTop: '10px', background: 'rgba(255,0,0,0.1)', border: '1px solid var(--red)', padding: '12px', borderRadius: '8px', alignItems: 'center' }}>
                                        <div style={{ color: 'var(--red)', fontFamily: 'Cinzel', fontSize: '0.9rem', textAlign: 'center', fontWeight: 'bold' }}>PENALTY WARNING</div>
                                        <div style={{ color: '#fff', fontFamily: 'Orbitron', fontSize: '0.7rem', textAlign: 'center', marginBottom: 5 }}>Skip this duty for 300 Capital?</div>
                                        <button id="mobBtnConfirmSkip" className="btn-skip-sm" style={{ background: 'var(--red)', color: 'white', borderColor: 'var(--red)', width: '70%', padding: '10px 0', display: 'block' }} onClick={() => (window as any).executeSkipTask()}>ACCEPT (-300)</button>
                                        <button id="mobBtnCancelSkip" className="text-btn" style={{ color: '#aaa', fontSize: '0.7rem', padding: '10px 0', background: 'none', border: 'none', width: '70%', display: 'block' }} onClick={() => (window as any).cancelSkipTask()}>I WILL SERVE</button>
                                    </div>
