                        ...
                        <div className="task-interface-container" style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            ...
                            <div id="activeTaskContent" className="hidden" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 10 }}>
                                ...
                                <div id="skipConfirmContainer" style={{ display: 'none', flexDirection: 'column', gap: 10, marginTop: 10, alignItems: 'center', width: '100%', border: '1px solid rgba(255,0,60,0.4)', background: 'rgba(20,0,0,0.8)', padding: '15px', borderRadius: '8px', backdropFilter: 'blur(5px)' }}>
                                    <div style={{ color: '#ff003c', fontFamily: 'Cinzel', fontSize: '1rem', textAlign: 'center', fontWeight: 'bold', letterSpacing: '1px', textShadow: '0 0 10px rgba(255,0,0,0.5)' }}>ARE YOU SURE?</div>
                                    <div style={{ color: '#ccc', fontFamily: 'Orbitron', fontSize: '0.7rem', textAlign: 'center', marginBottom: 5 }}>This will deduct <span style={{ color: '#ff003c', fontWeight: 'bold' }}>300 Capital</span>.</div>
                                    <button id="btnConfirmSkip" onClick={() => (window as any).executeSkipTask()} className="action-btn" style={{ width: 240, background: 'linear-gradient(90deg, #ff003c 0%, #8b0000 100%)', color: 'white', fontWeight: 'bold', border: '1px solid #ff003c', boxShadow: '0 0 15px rgba(255,0,60,0.4)', borderRadius: '8px', padding: '10px', fontSize: '0.8rem', letterSpacing: '2px' }}>ACCEPT PENALTY</button>
                                    <button id="btnCancelSkip" onClick={() => (window as any).cancelSkipTask()} className="text-btn" style={{ color: '#aaa', fontFamily: 'Orbitron', fontSize: '0.7rem', letterSpacing: 1, background: 'none', border: 'none', padding: 5, width: 240 }}>NEVERMIND, I WILL SERVE</button>
                                </div>
                            ...
                            <div className="luxury-card" style={{ padding: '15px 5px' }}>
                                ...
                                <div id="qm_TaskActive" className="hidden" style={{ textAlign: 'center' }}>
                                    ...
                                    <div id="mobSkipConfirmContainer" style={{ display: 'none', flexDirection: 'column', gap: 15, marginTop: 15, alignItems: 'center', background: 'rgba(20, 0, 0, 0.6)', border: '1px solid rgba(255, 0, 60, 0.4)', boxShadow: '0 0 20px rgba(255, 0, 60, 0.1)', backdropFilter: 'blur(10px)', padding: '25px', borderRadius: '12px', width: '100%' }}>
                                        <div style={{ color: '#ff003c', fontFamily: 'Cinzel', fontSize: '1.2rem', textAlign: 'center', fontWeight: 'bold', letterSpacing: '2px', textShadow: '0 0 10px rgba(255,0,0,0.5)' }}>ARE YOU SURE?</div>
                                        ...
                                        <button id="btnMobConfirmSkip" onClick={() => (window as any).executeSkipTask()} className="action-btn" style={{ width: '80%', background: 'linear-gradient(90deg, #ff003c 0%, #8b0000 100%)', color: 'white', fontWeight: 'bold', border: '1px solid #ff003c', boxShadow: '0 0 15px rgba(255,0,60,0.4)', borderRadius: '8px', padding: '12px', fontSize: '0.85rem', letterSpacing: '2px', cursor: 'pointer', transition: 'all 0.3s ease' }}>ACCEPT PENALTY</button>
