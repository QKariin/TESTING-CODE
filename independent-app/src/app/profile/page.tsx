                    ...
                    <div id="gridTask" className="v-card serve-grid-item" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between', gap: 10, minHeight: 'unset' }}>
                        ...
                        <div className="task-interface-container" style={{ flexGrow: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
                            ...
                            <div id="activeTaskContent" className="hidden" style={{ width: '100%', display: 'flex', flexDirection: 'column', gap: 10 }}>
                                ...
                                <div id="skipConfirmContainer" style={{ display: 'none', flexDirection: 'column', gap: 5, marginTop: 10, alignItems: 'center', width: '100%' }}>
                                    <div style={{ color: '#c5a059', fontFamily: 'Cinzel', fontSize: '0.9rem', textAlign: 'center', fontWeight: 'bold', letterSpacing: '1px' }}>CONFIRM SKIP?</div>
                                    <div style={{ color: '#888', fontFamily: 'Orbitron', fontSize: '0.65rem', textAlign: 'center', marginBottom: 10 }}>DEDUCT 300 CAPITAL</div>
                                    <button id="btnConfirmSkip" onClick={() => (window as any).executeSkipTask()} className="action-btn" style={{ width: 240, background: 'rgba(255,255,255,0.05)', backdropFilter: 'blur(10px)', color: '#c5a059', fontWeight: 'bold', border: '1px solid #c5a059', boxShadow: '0 0 15px rgba(197,160,89,0.2)' }}>ACCEPT PENALTY</button>
