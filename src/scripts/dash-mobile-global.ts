...
function openMobGlGifPicker() {
    ...
    panel.innerHTML = `
        ...
        <div style="padding:5px 0;text-align:right;"><span style="font-family:'Orbitron';font-size:0.32rem;color:rgba(255,255,255,0.12);letter-spacing:1px;">via GIPHY</span></div>
    `;
