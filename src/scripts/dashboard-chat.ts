    ...
    if (content.startsWith('TASK_REVIEW_CARD::')) {
        try {
            ...
            const taskTextLine = d.taskText
                ? `<div style="font-family:Rajdhani,sans-serif;font-size:0.48rem;color:rgba(255,255,255,0.35);letter-spacing:1px;margin-bottom:8px;overflow:hidden;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;">${purifier.sanitize(d.taskText)}</div>`
                : '';
            return `
                <div class="chat-gift-wrap">
