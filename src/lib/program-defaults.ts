// Shared program program defaults — THE SINGLE SOURCE OF TRUTH
// Used by both the dashboard (BasicProgramProgram) and all API routes for program generation.
...
export function defaultDayTasks(d: number): any[] {
    ...
    const t: any[] = [
        ...
        { type: 'daily_check', target: 1, label: 'Chastity check-in' },
    ];
