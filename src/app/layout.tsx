  ...
  return (
    <html lang="en">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.addEventListener('beforeinstallprompt',function(e){e.preventDefault();window._deferredInstallPrompt=e;var b=document.getElementById('pwaInstallBtn');var isStandalone=window.matchMedia('(display-mode: standalone)').matches||navigator.standalone===true;if(b&&!isStandalone){b.style.display='inline-block';}});` }} />
