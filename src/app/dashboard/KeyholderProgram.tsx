                    ...
                    return (
                        <div className="kfade" style={{ marginTop: 18, padding: '20px 24px', borderRadius: 16, background: 'rgba(15,15,20,0.9)', border: `1px solid rgba(${rgb},.25)`, backdropFilter: 'blur(12px)', boxShadow: `0 8px 32px rgba(0,0,0,.5), 0 0 20px rgba(${rgb},.08)` }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                                ...
                                {mechId === 'kneel' && (
                                    <div style={{ display: 'flex', gap: 8, alignItems: 'center' }}><span style={lbl}>SESSIONS REQUIRED</span><input type="number" min={1} max={24} value={task.target || 4} onChange={e => { updateTask(editIdx!, 'target', +e.target.value || 1); setEc({ ...ec }); }} style={{ ...inp, width: 80, padding: '8px 12px' }} /></div>
                                )}
