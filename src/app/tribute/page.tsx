...
const RANKS = [
    ...
    { title: "Footman", speakCost: 15, benefits: ["Presence: Your Face may be revealed.", "Order: Access to the Daily Routine.", "Challenges: Right to join all active challenges.", "Content: Access to exclusive content drops.", "Messages: Direct access to Queen Karin's DMs."], req: { tasks: 5, kneels: 10, points: 2000, spent: 0, streak: 0 } },
        ...
        <div style={{ background: '#020512', color: '#fff', overflowX: 'hidden' }}>
            ...
            <div className="main-content" style={{ position: 'relative', zIndex: 1, maxWidth: 680, margin: '0 auto', padding: 'clamp(48px,8vw,80px) clamp(20px,5vw,36px) 160px' }}>
                ...
                <div className="scroll-section" style={{ marginBottom: 80, maxWidth: 520, marginLeft: 'auto', marginRight: 'auto' }}>
                    ...
                    <div style={{ position: 'relative', background: 'rgba(5,8,18,0.97)', border: '1px solid rgba(197,160,89,0.18)', borderTop: '2px solid rgba(197,160,89,0.35)', borderRadius: 8, overflow: 'hidden', boxShadow: '0 4px 40px rgba(0,0,0,0.6)' }}>
                        ...
                        <div style={{ position: 'relative', zIndex: 1, padding: '18px 18px 16px' }}>
                            <div style={{ fontFamily: 'Orbitron,sans-serif', fontSize: '0.42rem', fontWeight: 400, letterSpacing: '8px', color: 'rgba(197,160,89,0.28)', textTransform: 'uppercase', textAlign: 'center', marginBottom: 16 }}>AWAITING ORDERS</div>
                            {!taskRevealed ? (
                ...
                <div className="scroll-section" style={{ marginBottom: 80, maxWidth: 520, marginLeft: 'auto', marginRight: 'auto' }}>
                    ...
                    <div style={{ position: 'relative', background: 'rgba(5,8,18,0.97)', border: '1px solid rgba(197,160,89,0.18)', borderTop: '2px solid rgba(197,160,89,0.35)', borderRadius: 8, overflow: 'hidden', boxShadow: '0 4px 40px rgba(0,0,0,0.6)' }}>
                        ...
                        {/* Header bar */}
                        <div style={{ position: 'relative', zIndex: 1, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '12px 18px 10px', borderBottom: '1px solid rgba(197,160,89,0.1)' }}>
                        ...
                        <div style={{ position: 'relative', zIndex: 1 }}>
                            <div style={{ padding: '16px 18px 14px', userSelect: 'none', pointerEvents: 'none' }}>
                ...
                <div className="scroll-section" style={{ marginBottom: 80, maxWidth: 520, marginLeft: 'auto', marginRight: 'auto' }}>
                    ...
                    <div style={{ position: 'relative', background: 'rgba(5,8,18,0.97)', border: '1px solid rgba(197,160,89,0.18)', borderTop: '2px solid rgba(197,160,89,0.35)', borderRadius: 8, overflow: 'hidden', boxShadow: '0 4px 40px rgba(0,0,0,0.6)' }}>
                        ...
                        {/* Locked body */}
                        <div style={{ position: 'relative', zIndex: 1 }}>
                            <div style={{ padding: '16px 18px 14px', userSelect: 'none', pointerEvents: 'none', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14 }}>
                ...
                <div className="scroll-section" style={{ textAlign: 'center' }}>
                    ...
                    <button onClick={() => setShowApplication(true)} style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 12, width: '100%', maxWidth: 340, margin: '0 auto 32px', padding: '18px 24px', background: 'rgba(4,2,8,0.97)', border: '1px solid rgba(180,30,30,0.6)', borderTop: '2px solid rgba(200,40,40,0.8)', color: 'rgba(200,40,40,0.9)', fontFamily: 'Cinzel,serif', fontWeight: 700, fontSize: '0.8rem', letterSpacing: '8px', textTransform: 'uppercase', cursor: 'pointer', borderRadius: 4, boxShadow: '0 0 30px rgba(180,0,0,0.1),0 8px 40px rgba(0,0,0,0.4)' }}>
                        <svg width="14" height="17" viewBox="0 0 14 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <circle cx="7" cy="12" r="1.2" fill="rgba(200,40,40,0.85)"/>
                            <line x1="7" y1="12" x2="7" y2="14" stroke="rgba(200,40,40,0.85)" strokeWidth="1.4" strokeLinecap="round"/>
                        </svg>
                        Application
                    </button>
