...
export default function TributePage() {
    ...
    return (<>
        <div style={{ position: 'fixed', top: -50, left: 0, width: '100%', height: 'calc(100lvh + 100px)', zIndex: 0, backgroundImage: "url('/queen-payment-bg.png')", backgroundSize: 'cover', backgroundPosition: 'center center', opacity: 0.75, filter: 'saturate(0.7) brightness(0.9) blur(3px)' }} />
        <div style={{ position: 'fixed', top: -50, left: 0, width: '100%', height: 'calc(100lvh + 100px)', zIndex: 0, background: 'linear-gradient(180deg, rgba(2,2,2,0.2) 0%, rgba(2,2,2,0.5) 60%, rgba(2,2,2,0.75) 100%)', pointerEvents: 'none' }} />
