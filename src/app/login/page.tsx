...
export default function LoginPage() {
    ...
    return (
        <div className="login-container">
            ...
            <div className="login-content-wrap" style={{ position: 'relative', zIndex: 10, width: '100%', maxWidth: 440, padding: '0 clamp(20px,5vw,32px)', textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', flex: 1 }}>
                <div style={{ animation: mounted ? 'loginFadeIn 1.2s ease-out both' : 'none' }}>
                    <div style={{ position: 'relative', width: 80, height: 80, margin: '0 auto 18px' }}>
                        <div style={{ position: 'absolute', inset: -6, borderRadius: '50%', border: '1px solid rgba(197,160,89,0.2)', animation: 'loginRingExpand 4s ease-in-out infinite' }} />
                        <div style={{ position: 'absolute', inset: -14, borderRadius: '50%', border: '1px solid rgba(197,160,89,0.08)', animation: 'loginRingExpand 4s ease-in-out infinite 0.7s' }} />
                        <img src="/queen-karin.png" alt="Queen Karin" style={{ width: 80, height: 80, borderRadius: '50%', objectFit: 'cover', border: '1.5px solid rgba(197,160,89,0.35)', boxShadow: '0 0 60px rgba(0,0,0,0.8), 0 0 30px rgba(197,160,89,0.08)' }} onError={e => { (e.target as HTMLImageElement).style.display = 'none'; }} />
                    </div>
                    <h1 style={{ fontFamily: 'Cinzel, serif', fontSize: 'clamp(1.4rem, 5vw, 2rem)', color: '#fff', letterSpacing: 4, textTransform: 'uppercase', margin: '0 0 4px', fontWeight: 600, lineHeight: 1.05 }}>QUEEN KARIN</h1>
                    <div style={{ width: 40, height: '1.5px', margin: '12px auto 0', background: 'linear-gradient(90deg, transparent, #c5a059, transparent)' }} />
                </div>

                <div className="login-card" style={{ marginTop: 32, animation: mounted ? 'loginFadeUp 1s ease-out 0.4s both' : 'none' }}>
